...
public class MyOpenDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE account(accid INTEGER PRIMARY KEY AUTOINCREMENT,accaction VARCHAR(400),accmoney DOUBLE,acclist VARCHAR(400),accsay VARCHAR(400),acctime VARCHAR(100),accpic VARCHAR(1000))");
